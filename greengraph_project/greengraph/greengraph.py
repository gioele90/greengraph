...
def main():
	parser = ArgumentParser(description = "Graph the amount of green in a given amount of steps between two locations")
	parser.add_argument('--start')
	parser.add_argument('--stop')
	parser.add_argument('--steps',type=int)
	parser.add_argument('--out')
	arguments= parser.parse_args()
	mygraph=Greengraph(arguments.start,arguments.stop)
